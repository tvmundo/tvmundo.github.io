...
const menutvmundo1 = document.getElementById('menutvmundo1');
...
function openMenu() {
  ...
  menutvmundo1.textContent = 'Ocultar Lista de Vídeos';
}

// Função para fechar o menu
function closeMenuOverlay() {
  videoMenu.style.display = 'none';
  menutvmundo1.textContent = 'Mostrar Lista de Vídeos';
}

// Alternar visibilidade do menu overlay
menutvmundo1.addEventListener('click', () => {
